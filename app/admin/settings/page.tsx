      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-[#0f1629] border border-white/10 rounded-xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Blog Contributor Access</h2>
              <p className="text-xs text-gray-500">Role-based permissions for blog contributors</p>
            </div>
          </div>
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3 p-3 bg-white/3 rounded-lg border border-white/5">
              <CheckCircle size={14} className="text-green-400 shrink-0" />
              <span className="text-gray-300">Contributors can write and edit blog posts</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/3 rounded-lg border border-white/5">
              <CheckCircle size={14} className="text-green-400 shrink-0" />
              <span className="text-gray-300">Contributors can add affiliate widgets to their own blog posts</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/3 rounded-lg border border-white/5">
              <div className="w-3.5 h-3.5 rounded-full border border-red-400/50 shrink-0" />
              <span className="text-gray-500">Contributors cannot change global widget settings</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-white/3 rounded-lg border border-white/5">
              <div className="w-3.5 h-3.5 rounded-full border border-red-400/50 shrink-0" />
              <span className="text-gray-500">Contributors cannot access platform management</span>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-3">
            <Link
              href="/admin/users/new"
              className="text-xs bg-green-400/10 hover:bg-green-400/20 text-green-400 border border-green-400/20 px-3 py-2 rounded-lg flex items-center gap-1.5"
            >
              <Users size={12} /> Create Contributor Account
            </Link>
            <Link
              href="/admin/blog-ads"
              className="text-xs bg-yellow-400/10 hover:bg-yellow-400/20 text-yellow-400 border border-yellow-400/20 px-3 py-2 rounded-lg flex items-center gap-1.5"
            >
              <Megaphone size={12} /> Manage Blog Ads
            </Link>
          </div>
        </div>
